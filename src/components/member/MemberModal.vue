  ...
  <div v-if="isOpen" class="modal-overlay" @click.self="emit('close')">
    <div class="modal">
      <div class="modal-header">
        <h2 class="modal-title">{{ readOnly ? '查看成员' : (isEditing ? '编辑成员' : '新建成员') }}</h2>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <select v-model="form.role" class="input select" :disabled="readOnly">
      ...
      <div class="modal-footer">
        ...
        <button v-if="!readOnly" class="btn btn-primary" @click="handleSubmit">保存</button>
      </div>
    </div>
  </div>
</template>
